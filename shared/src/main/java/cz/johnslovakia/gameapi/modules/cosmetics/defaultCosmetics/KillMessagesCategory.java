...
public class KillMessagesCategory extends CosmeticsCategory {
    ...
    public KillMessagesCategory(CosmeticsModule manager) {
        ...
        Cosmetic dragon = new Cosmetic("Dragon", new ItemStack(Utils.getCustomHead("31d6e3e41145967b32fb63576c63e3057e63beceb73cea18d20fc8547b0b0645")), CosmeticRarity.EPIC)
        ...
        Cosmetic genAlpha = new Cosmetic("Gen Alpha", Utils.getCustomHead("760cdc9a43b1cd35bbe47ab50fd25faa7cd218bc7ec66e2227df664572748cc4"), CosmeticRarity.LEGENDARY)
                .addCost(manager.getMainResource(), LEGENDARY_COINS_PRICE)
                .addCost(ModuleManager.getModule(ResourcesModule.class).getResourceByName("CosmeticTokens"), LEGENDARY_TOKEN_PRICE);
