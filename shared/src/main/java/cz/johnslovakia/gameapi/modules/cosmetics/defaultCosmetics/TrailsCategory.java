...
public class TrailsCategory extends CosmeticsCategory {
    ...
    public TrailsCategory(CosmeticsModule manager) {
        ...
        Cosmetic presents = new Cosmetic("Presents", Utils.getCustomHead("12919c67317c7678438ff520c98dde0e3b4d68769c8938a5a3de2968edfc7314"), CosmeticRarity.EPIC)
                ...
                .setLocationConsumer(location -> {
                    ItemStack itemStack =  new ItemBuilder(Utils.getCustomHead("12919c67317c7678438ff520c98dde0e3b4d68769c8938a5a3de2968edfc7314")).setName(UUID.randomUUID().toString()).toItemStack();
                    ItemUtils.getInstance().markAsNoPickup(itemStack);
        ...
        Cosmetic usaFlag = new Cosmetic("USA Flag", Utils.getCustomHead("46c9923bebd9ad90a80a0731c3f3b9db729b0785015e18e3ec07e4e91099be06"), CosmeticRarity.EPIC)
                ...
                .addCost(ModuleManager.getModule(ResourcesModule.class).getResourceByName("CosmeticTokens"), EPIC_TOKEN_PRICE)
                .setLocationConsumer(location -> {
                    ItemStack itemStack =  new ItemBuilder(Utils.getCustomHead("46c9923bebd9ad90a80a0731c3f3b9db729b0785015e18e3ec07e4e91099be06")).setName(UUID.randomUUID().toString()).toItemStack();
                    ItemUtils.getInstance().markAsNoPickup(itemStack);
        ...
        Cosmetic czechFlag = new Cosmetic("Czech Flag", Utils.getCustomHead("48152b7334d7ecf335e47a4f35defbd2eb6957fc7bfe94212642d62f46e61e"), CosmeticRarity.EPIC)
                ...
                .addCost(ModuleManager.getModule(ResourcesModule.class).getResourceByName("CosmeticTokens"), EPIC_TOKEN_PRICE)
                .setLocationConsumer(location -> {
                    ItemStack itemStack =  new ItemBuilder(Utils.getCustomHead("48152b7334d7ecf335e47a4f35defbd2eb6957fc7bfe94212642d62f46e61e")).setName(UUID.randomUUID().toString()).toItemStack();
                    ItemUtils.getInstance().markAsNoPickup(itemStack);
        ...
        Cosmetic ukFlag = new Cosmetic("UK Flag", Utils.getCustomHead("8831c73f5468e888c3019e2847e442dfaa88898d50ccf01fd2f914af544d5368"), CosmeticRarity.EPIC)
                ...
                .addCost(ModuleManager.getModule(ResourcesModule.class).getResourceByName("CosmeticTokens"), EPIC_TOKEN_PRICE)
                .setLocationConsumer(location -> {
                    ItemStack itemStack =  new ItemBuilder(Utils.getCustomHead("8831c73f5468e888c3019e2847e442dfaa88898d50ccf01fd2f914af544d5368")).setName(UUID.randomUUID().toString()).toItemStack();
                    ItemUtils.getInstance().markAsNoPickup(itemStack);
    ...
    public Set<CTrigger<?>> getTriggers() {
        ...
        CTrigger<ProjectileLaunchEvent> trigger = new CTrigger<>(ProjectileLaunchEvent.class,
                projectileLaunchEvent -> (Player) projectileLaunchEvent.getEntity().getShooter(),
                e -> e.getEntity().getShooter() instanceof Player,
                projectileLaunchEvent -> {
                    Player player = (Player) projectileLaunchEvent.getEntity().getShooter();
                    Cosmetic cosmetic = ModuleManager.getModule(CosmeticsModule.class).getPlayerSelectedCosmetic(PlayerIdentityRegistry.get(player), this);
                    if (cosmetic == null){
                        return;
                    }
                    if (!(projectileLaunchEvent.getEntity() instanceof Arrow || projectileLaunchEvent.getEntity() instanceof Trident || projectileLaunchEvent.getEntity() instanceof Snowball || projectileLaunchEvent.getEntity() instanceof Egg || projectileLaunchEvent.getEntity() instanceof Fireball)){
                        return;
                    }
