...
public class Trigger<E extends Event> {
    ...
    private final Consumer<PlayerIdentity> response;
    ...
    public <T extends Number> Trigger(Class<E> eventClass, Mapper<E> mapper, Consumer<PlayerIdentity> response) {
        Validate.notNull(eventClass, "eventClass cannot be null");
        Validate.notNull(mapper, "mapper cannot be null");
    ...
    public <T extends Number> Trigger(Class<E> eventClass, Mapper<E> mapper, Predicate<E> validator, Consumer<PlayerIdentity> response) {
        Validate.notNull(eventClass, "eventClass cannot be null");
        Validate.notNull(mapper, "mapper cannot be null");
        Validate.notNull(validator, "validator cannot be null");
        Validate.notNull(response, "response cannot be null");
    ...
    /**
     * Retrieves {@link PlayerIdentity} object from event using mapper, representing a member
     * @param event Incoming event
     * @return {@link PlayerIdentity} representation of member
     */
    public List<PlayerIdentity> compute(Event event){
    ...
    public Consumer<PlayerIdentity> getResponse() {
        return response;
    }
}