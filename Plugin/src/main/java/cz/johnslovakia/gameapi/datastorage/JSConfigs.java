...
public class JSConfigs {
    ...
    public static void createTable(SQLDatabaseConnection connection){
    ...
    public JSConfigs(SQLDatabaseConnection connection) {
    ...
    public String loadConfig(String key) {
        if (connection.getConnection() == null) return null;
