...
public class PlayerBossBar {
    ...
    public void setName(Component component){
        Component name = Component.text("")
                .append(TextBackground.getTextWithBackgroundBackground(component));
    ...
    public void setName(Component left, Component center, Component right) {
        ...
        if (hasLeft && hasCenter && hasRight) {
            name = name
                    .append(TextBackground.getTextWithBackgroundBackground(left))
                    .append(off(leftSpace))
                    .append(TextBackground.getTextWithBackgroundBackground(center))
                    .append(off(rightSpace))
                    .append(TextBackground.getTextWithBackgroundBackground(right));
            ...
            name = name.append(TextBackground.getTextWithBackgroundBackground(center));
        }
