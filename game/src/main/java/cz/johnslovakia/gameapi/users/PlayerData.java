                ...
                if (jsonString != null) {
                    ...
                    for (int i = 0; i < questsArray.length(); i++) {
                        ...
                        if (status.equals(PlayerQuestData.Status.COMPLETED)) {
                            questData = new PlayerQuestData(gamePlayer, quest, startDate, PlayerQuestData.Status.COMPLETED);
                        } else {
                            questData = new PlayerQuestData(gamePlayer, quest, startDate, progress);
                        }
